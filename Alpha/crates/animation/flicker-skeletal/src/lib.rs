...
//!
//! GPU-free, viewer-agnostic. A renderer (`flicker-paperdoll` + `flicker-packeditor`)
//! turns this crate's posed bone transforms and skinned vertices into draw calls;
//! nothing here touches wgpu.
//!
