...
- **Burning a banner** — erasing a character from the tapestry entirely — is available **only as a difficult activity**, an LTO in its own right: you must *learn how to burn a ghost from your tapestry*, and it is hard and slow by design. Burning a master also strips the account of that school's access for the Muse's gate (The Endgame Arc; ledger 24DB0883).
...
**Longevity buys experience (Elideus, 2026-09-04; ledger 24DB0883).** Long-lived races earn a **larger overall experience pool across a lifetime** and so can spend more points on skills — enough for one elf to master several schools in one life. This is the mechanical face of race-as-tempo (Book V, Peoples; ledger D06D41CB) and the reason the Muse's gate counts school coverage, not lifetimes (The Endgame Arc). Pool sizes are `[BUILD]`.
...
The endgame of the adventurer's game spans character lifetimes: **master all fourteen schools — both Domains of every color — across the generations of a family line, and, during a celestial alignment, reunite or re-shatter the Prism.** (Ledger 10A6150F, Seed canon 12; "all seven schools" was ruled 2026-07-02 to mean at least one school from each color — ledger A8FF6AB0 — and **reversed 2026-08-27**: mastery is all fourteen, the explicit player-facing endgame objective — ledger 6B2048A6.) It is the canonical maximal **LTO** (above).
...
**The arc is the Muse's path** (ruled 2026-07-01/02; ledgers BDB707A5, EC054473). The player walks the road the Lonely Muse walked — apprentice across all fourteen schools in one lifetime — taught by the masters the family's Tapestry keeps reachable (gate 1, below; ledger 24DB0883) — mastering both Domains of every color (ledger 6B2048A6, reversing A8FF6AB0), and stand at the summit she was denied (Book VI). Completing it is a **terminal epic quest**: the choice between reuniting and re-shattering is offered, made personally, and **retires the character**. The shared world persists — permanent world-scale change is not simulated; "that's where a character would retire." Nobody does this by accident, or on their first character, or their tenth.

The gate stack is canon (ledger EC054473):

1. The account's Tapestry must hold a **master of each of the fourteen schools** — both Domains of every color — **in an active benefit form** (ruled 2026-09-04, ledger 24DB0883; sharpening EC054473 under the fourteen-school mastery of 6B2048A6). **Coverage, not count:** it is one condition per school, not one lifetime per school — a single long-lived master who mastered several schools covers each of them, which is exactly why long-lived races earn a larger experience pool (Progression, above). **Active benefit form** means the thread still confers its benefit: a **ghost you can ask questions of**, a **library left behind**, an **eternal guardian** bound to a place or object as a font of wisdom, or an **imbued relic** whose fused soul still speaks (the transcendent dispositions above; confirmed 2026-09-04). A **burned** thread of a master confers nothing; a **ghosted thread that cannot communicate** confers nothing. The Tapestry is the account-bound benefits layer, and eligibility is holding **valid, current access** to all fourteen schools through it at the time of the attempt.
...
*[Resolved 2026-07-02 as at least one school from each color (ledger A8FF6AB0, closing FCB93BC0); **reversed 2026-08-27**: mastery is all fourteen schools, the design's stated endgame objective, modeled on the Muse's myth — ledger 6B2048A6.]*
...
- Whether mastery — all fourteen schools (ledger 6B2048A6) — includes psionics, a discipline outside the schools, is unresolved (ledger 7609E7E9).
